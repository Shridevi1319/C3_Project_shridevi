...
class RestaurantTest {
    ...
    public void verify_the_order_value_of_the_items_in_the_list(){
        ...
        selectedItems.addSelectedItems(Item.returnItemObject("Sandwich", 2));
        selectedItems.addSelectedItems(Item.returnItemObject("Honey potato", 3));
        selectedItems.addSelectedItems(Item.returnItemObject("Vanilla Ice", 3));
        Assertions.assertEquals(8,selectedItems.getTotalValueOfSelectedItems());
